...
function Captionsignup() {
  ...
  const [CaptionData, setCaptionData] = useState({ firstname: '', lastname: '', email: '', password: '' })
  ...
  const handleChange = (e) => {
    ...
    if (name === 'email') {
      ...
      setFirstname(value)
      setCaptionData({ ...CaptionData, firstname: value })
    } else if (name === 'lastname') {
      setLastname(value)
      setCaptionData({ ...CaptionData, lastname: value })
    }
  }
